      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-center mb-12 max-w-2xl mx-auto opacity-90">
            Work-integrated learning across all programs
          </p>
            ...
            <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-8 border border-primary-foreground/20">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span>Tailored learning journeys</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-primary-foreground/10 backdrop-blur-sm rounded-lg p-8 border border-primary-foreground/20">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex items-center gap-2">
                  ...
                  <span>Solar installation & maintenance</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>Mentored industry experience</span>
                </li>
                <li className="flex items-center gap-2">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                  <span>Pathway to permanent employment</span>
                </li>
              </ul>
            </div>
          </div>
